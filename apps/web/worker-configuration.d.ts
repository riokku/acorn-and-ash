/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0112f46ef44abc6566769d090a33b0f4)
// Runtime types generated with workerd@1.20260916.1 2026-08-22 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	WORLD: DurableObjectNamespace /* World from acorn-ash-game-server-staging */ | DurableObjectNamespace /* World from acorn-ash-game-server-production */ | DurableObjectNamespace /* World from acorn-ash-game-server */;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		ASSETS: Fetcher;
		WORLD: DurableObjectNamespace /* World from acorn-ash-game-server-staging */;
	}
	interface ProductionEnv {
		ASSETS: Fetcher;
		WORLD: DurableObjectNamespace /* World from acorn-ash-game-server-production */;
	}
