/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e56f46080dbca01bdb3ce591bd01a8be)
// Runtime types generated with workerd@1.20260916.1 2026-08-22 
interface __BaseEnv_Env {
	WORLD: DurableObjectNamespace<import("./src/index").World>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "World";
	}
